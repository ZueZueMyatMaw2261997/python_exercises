 ...
 mission is to get the neutron destruct bomb from the Weapons Armory, p 
 it in the bridge, and blow the ship up after getting into an escape po 
 ...
 grab the neutron bomb and run as fast as you can to the bridge where y 
 must place it in the right spot. 
 
 You burst onto the Bridge with the netron destruct bomb under your arm 
 and surprise 5 Gothons who are trying to take control of the ship. Eac 
 of them has an even uglier clown costume than the last. They haven't 
 pulled their weapons out yet, as they see the active bomb under your a 
 ...
 chamber with the escape pods, and now need to pick one to take. Some o 
 ...
 the_end_winner = Room("The End", 
         """ 
         You jump into pod 2 and hit the eject button. The pod easily slides ou 
 ...
 the_end_loser = Room("The End", 
         ...
         out into the void of space, then implodes as the hull ruptures, crushi 
